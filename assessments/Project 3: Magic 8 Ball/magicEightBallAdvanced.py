...
#List of responses
answers=[yes1, yes2, yes3, yes4, no1, no2, no3, no4, maybe1, maybe2]

#Variable for exit condition ("y" to play again)
playAgain = "y"

#While loop to continue game as long as player wants to ask another question
while playAgain == "y":
...
#Computer picks Magic 8 Ball response
  responseNum=random.randint(0, 9)
